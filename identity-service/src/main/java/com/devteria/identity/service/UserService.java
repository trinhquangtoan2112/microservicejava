...
import com.devteria.identity.repository.httpclient.ProfileClientRepository;
...
public class UserService {
    ...
    ProfileClientRepository profileClientRepository;
    ...
    public UserResponse createUser(UserCreationRequest request) {
        ...
        user.setRoles(roles);
        var profile = profileMapper.toUserProfileRequest(request);
        profile.setUserId(user.getId());
        var profileResponse = profileClientRepository.createProfile(profile);
